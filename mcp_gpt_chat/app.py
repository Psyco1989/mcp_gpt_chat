...
def save_anthropic_messages(messages):
...
def serialize_anthropic_block(block):
    """Konvertiert einen Anthropic-Content-Block in ein Dictionary."""
...
def serialize_anthropic_response(response):
    """Speichert die Claude-Content-Blöcke."""
    ...
    for block in content:
        serialized = serialize_anthropic_block(block)
...
def chat():
    ...
    try:
        ...
        history = load_anthropic_messages()
        ...
        response_content = serialize_anthropic_response(
            response
        )
        ...
        save_anthropic_messages(history)
